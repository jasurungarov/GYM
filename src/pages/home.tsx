		...
		<>
			<div className='w-full h-screen flex items-center'>
				<div className='max-w-xl ml-60 flex h-full flex-col justify-center'>
					<h1 className='text-8xl font-semibold uppercase'>Workout with me</h1>
					...
					{user ? (
						<div className='flex gap-4'>
							...
							<Button className='w-fit mt-6 font-bold h-12' variant={'destructive'} 
							size={'lg'}
							onClick={onLogout}
							>
								<span>Logout</span>
